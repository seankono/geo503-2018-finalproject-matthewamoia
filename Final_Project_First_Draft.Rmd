...
```{r, loading pacjages, message=F, warning=F}
...
d <- occ(query= 'Clemmys guttata', from = 'gbif', limit = 1000) %>% occ2df(what = "all") 
```

Figures will eventually be created. I had some difficulty and hopefully a classmate can help met out sometime. 
